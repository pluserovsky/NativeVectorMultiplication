...
public class Program {
    static {
        try {
            ...
            System.err.println("Unable to load native library:: " + e);
            System.exit(1);
        }
    }
    ...
    public static void ShowAvailableOptions(){
        l("1 - Multi01 - multiply vectors");
        l("2 - Multi02 - multiply the same vector");
        l("3 - Multi03 - natice multiply");
        l("4 - exit");
        l("Choose option");
    }
